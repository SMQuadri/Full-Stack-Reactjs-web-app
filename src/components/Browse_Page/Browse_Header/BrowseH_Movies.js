  ...
  return(
    <div className="browseH" style={{backgroundImage: `URL(${Background})`}} >
      ...
      <div className="browseH__content">
        <span className="browseH__title">Watch The Irishman Now</span>
        <span className="browseH__desc">'The Irishman' is a fictionalized true crime story about the disappearance of Jimmy Hoffa, a mystery that still hasn't been solved. Long-time International Brotherhood of Teamsters boss, James "Jimmy" Hoffa, went missing in 1975.</span>
